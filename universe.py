...
TRACKS = [
 ...
 {"n":"科技巨头与云","en":"Big Tech & Cloud","layer":"下游·平台","stars":5,
  "desc":"全球超大规模 AI 资本开支的主力,云+模型+应用一体,2026 capex 近 7000 亿美元。",
  "us":[("MSFT","微软","Microsoft"),("GOOGL","谷歌","Alphabet"),("AMZN","亚马逊","Amazon"),("META","Meta","Meta"),("AAPL","苹果","Apple"),("ORCL","甲骨文","Oracle"),("NOW","ServiceNow","ServiceNow"),("CRM","Salesforce","Salesforce"),("SAP","SAP","SAP"),("IBM","IBM","IBM"),("ADBE","Adobe","Adobe"),("CSCO","思科","Cisco"),("ACN","埃森哲","Accenture"),("INTU","Intuit","Intuit"),("UBER","优步","Uber"),("SHOP","Shopify","Shopify"),("WDAY","Workday","Workday"),("TEAM","Atlassian","Atlassian"),("SNOW","Snowflake","Snowflake"),("PANW","Palo Alto","Palo Alto Networks")],
  "cn":[("688111","金山办公"),("600588","用友网络"),("002230","科大讯飞"),("600570","恒生电子"),("002410","广联达"),("603039","泛微网络"),("688369","致远互联"),("300059","东方财富"),("300033","同花顺"),("000032","深桑达"),("300253","卫宁健康"),("688066","航天宏图"),("688031","星环科技"),("688158","优刻得"),("688316","青云科技"),("688058","宝兰德"),("603138","海量数据"),("688095","福昕软件"),("300634","彩讯股份"),("300339","润和软件")],
  "etf":[("QQQ","Invesco纳指100","Invesco QQQ"),("IGV","iShares软件ETF","iShares Software ETF"),("AIQ","Global X AI ETF","Global X AI & Tech ETF"),("SKYY","First Trust云计算ETF","First Trust Cloud Computing ETF"),("159939","信息技术ETF")]},

 {"n":"AI 软件与应用","en":"AI Software & Apps","layer":"下游·应用","stars":5,
  "desc":"AI 落地的应用与数据层:Agent、SaaS、数据平台、大模型应用,弹性大、估值高。",
  "us":[("PLTR","Palantir","Palantir"),("SNOW","Snowflake","Snowflake"),("DDOG","Datadog","Datadog"),("CRWD","CrowdStrike","CrowdStrike"),("NET","Cloudflare","Cloudflare"),("MDB","MongoDB","MongoDB"),("U","Unity","Unity"),("PATH","UiPath","UiPath"),("AI","C3.ai","C3.ai"),("ESTC","Elastic","Elastic"),("ZS","Zscaler","Zscaler"),("S","SentinelOne","SentinelOne"),("GTLB","GitLab","GitLab"),("HUBS","HubSpot","HubSpot"),("APP","AppLovin","AppLovin"),("DOCN","DigitalOcean","DigitalOcean"),("FROG","JFrog","JFrog"),("BRZE","Braze","Braze"),("CFLT","Confluent","Confluent"),("PCOR","Procore","Procore")],
  "cn":[("300624","万兴科技"),("688088","虹软科技"),("688327","云从科技"),("688207","格灵深瞳"),("300229","拓尔思"),("002362","汉王科技"),("300678","中科信息"),("688590","新致软件"),("601360","三六零"),("300418","昆仑万维"),("688588","凌志软件"),("300378","鼎捷软件"),("300687","赛意信息"),("688229","博睿数据"),("300451","创业慧康"),("002777","久远银海"),("300339","润和软件"),("688201","信安世纪"),("300634","彩讯股份"),("300271","华宇软件")],
  "etf":[("WCLD","WisdomTree云软件ETF","WisdomTree Cloud Computing ETF"),("IGV","iShares软件ETF","iShares Software ETF"),("AIQ","Global X AI ETF","Global X AI & Tech ETF"),("BOTZ","Global X机器人AI ETF","Global X Robotics & AI ETF"),("159852","软件ETF")]},

 {"n":"机器人与自动化","en":"Robotics & Automation","layer":"下游·智造","stars":5,
  "desc":"人形机器人+工业自动化,减速器/伺服/控制/丝杠等国产链景气,特斯拉 Optimus 催化。",
  "us":[("TSLA","特斯拉","Tesla"),("ISRG","直觉外科","Intuitive Surgical"),("ROK","罗克韦尔","Rockwell Automation"),("SYM","Symbotic","Symbotic"),("ZBRA","斑马技术","Zebra"),("IRBT","iRobot","iRobot"),("HON","霍尼韦尔","Honeywell"),("EMR","艾默生","Emerson"),("ROP","Roper","Roper"),("AME","AMETEK","AMETEK"),("DE","迪尔","Deere"),("PH","派克汉尼汾","Parker Hannifin"),("NDSN","诺信","Nordson"),("CGNX","康耐视","Cognex"),("AVAV","AeroVironment","AeroVironment")],
  "cn":[("300124","汇川技术"),("002747","埃斯顿"),("688017","绿的谐波"),("688305","科德数控"),("601689","拓普集团"),("002050","三花智控"),("603728","鸣志电器"),("688160","步科股份"),("002979","雷赛智能"),("688320","禾川科技"),("603667","五洲新春"),("002472","双环传动"),("002896","中大力德"),("300503","昊志机电"),("688188","柏楚电子"),("603416","信捷电气"),("300024","机器人"),("300660","江苏雷利"),("003021","兆威机电"),("301368","丰立智能")],
  "etf":[("BOTZ","Global X机器人AI ETF","Global X Robotics & AI ETF"),("ROBO","ROBO Global机器人ETF","ROBO Global Robotics ETF"),("IRBO","iShares机器人AI ETF","iShares Robotics & AI ETF"),("562500","机器人ETF"),("159770","机器人ETF")]},

 {"n":"智能汽车与自动驾驶","en":"Smart EV & Autonomous","layer":"下游·出行","stars":4,
  "desc":"电动化+智能化,自动驾驶芯片/域控/激光雷达/智能座舱,中美新能源与 ADAS 双主线。",
  "us":[("TSLA","特斯拉","Tesla"),("NIO","蔚来","NIO"),("XPEV","小鹏","XPeng"),("LI","理想","Li Auto"),("RIVN","Rivian","Rivian"),("LCID","Lucid","Lucid"),("MBLY","Mobileye","Mobileye"),("GM","通用","General Motors"),("F","福特","Ford"),("APTV","安波福","Aptiv"),("ALV","奥托立夫","Autoliv"),("LAZR","Luminar","Luminar"),("INDI","indie半导体","indie Semiconductor"),("QS","QuantumScape","QuantumScape"),("VC","Visteon","Visteon")],
  "cn":[("002594","比亚迪"),("002920","德赛西威"),("300496","中科创达"),("688326","经纬恒润"),("600699","均胜电子"),("603596","伯特利"),("603197","保隆科技"),("002906","华阳集团"),("603786","科博达"),("603348","文灿股份"),("301221","光庭信息"),("002405","四维图新"),("002151","北斗星通"),("601127","赛力斯"),("000625","长安汽车"),("601238","广汽集团"),("601633","长城汽车"),("600418","江淮汽车"),("002284","亚太股份"),("688256","寒武纪")],
  "etf":[("DRIV","Global X自动驾驶EV ETF","Global X Autonomous & EV ETF"),("IDRV","iShares自动驾驶EV ETF","iShares Self-Driving EV & Tech ETF"),("KARS","KraneShares电动车ETF","KraneShares Electric Vehicles ETF"),("515030","新能源车ETF"),("159637","新能源车龙头ETF")]},

 {"n":"AI 电力与能源","en":"AI Power & Energy","layer":"中游·能源","stars":5,
  "desc":"AI 数据中心耗电激增,发电(核电/燃机)、电网设备、储能、光伏受益,电力成 AI 卡点。",
  "us":[("VST","Vistra","Vistra"),("CEG","星座能源","Constellation Energy"),("NRG","NRG能源","NRG Energy"),("TLN","Talen能源","Talen Energy"),("GE","通用电气","GE Aerospace"),("NEE","新纪元能源","NextEra Energy"),("SO","南方电力","Southern Company"),("DUK","杜克能源","Duke Energy"),("FSLR","First Solar","First Solar"),("ENPH","Enphase","Enphase"),("FLNC","Fluence储能","Fluence Energy"),("BE","Bloom Energy","Bloom Energy"),("SHLS","Shoals","Shoals"),("RUN","Sunrun","Sunrun"),("AES","AES电力","AES Corp")],
  "cn":[("600900","长江电力"),("601985","中国核电"),("003816","中国广核"),("300750","宁德时代"),("300274","阳光电源"),("600089","特变电工"),("002028","思源电气"),("600406","国电南瑞"),("000400","许继电气"),("600312","平高电气"),("688676","金盘科技"),("600875","东方电气"),("601727","上海电气"),("688390","固德威"),("300763","锦浪科技"),("605117","德业股份"),("603063","禾望电气"),("605305","中际联合"),("300491","通合科技"),("300014","亿纬锂能")],
  "etf":[("GRID","First Trust电网ETF","First Trust Clean Edge Grid ETF"),("XLU","公用事业ETF","Utilities Select Sector SPDR"),("ICLN","iShares清洁能源ETF","iShares Global Clean Energy ETF"),("TAN","Invesco太阳能ETF","Invesco Solar ETF"),("561560","电力ETF")]},

 {"n":"网络安全","en":"Cybersecurity","layer":"下游·安全","stars":4,
  "desc":"AI 时代攻防升级,云安全/零信任/终端安全需求刚性,中美各有龙头。",
  "us":[("PANW","Palo Alto","Palo Alto Networks"),("CRWD","CrowdStrike","CrowdStrike"),("ZS","Zscaler","Zscaler"),("FTNT","Fortinet","Fortinet"),("OKTA","Okta","Okta"),("CYBR","CyberArk","CyberArk"),("QLYS","Qualys","Qualys"),("TENB","Tenable","Tenable"),("RPD","Rapid7","Rapid7"),("S","SentinelOne","SentinelOne"),("NET","Cloudflare","Cloudflare"),("GEN","Gen Digital","Gen Digital"),("AKAM","Akamai","Akamai"),("CHKP","Check Point","Check Point"),("VRNS","Varonis","Varonis")],
  "cn":[("601360","三六零"),("300454","深信服"),("002439","启明星辰"),("688561","奇安信"),("300369","绿盟科技"),("002212","天融信"),("688023","安恒信息"),("002268","卫士通"),("300188","美亚柏科"),("300768","迪普科技"),("300311","任子行"),("603232","格尔软件"),("300579","数字认证"),("003029","吉大正元"),("688030","山石网科"),("300659","中孚信息"),("688225","亚信安全"),("300386","飞天诚信"),("688201","信安世纪"),("300229","拓尔思")],
  "etf":[("CIBR","First Trust网络安全ETF","First Trust Nasdaq Cybersecurity ETF"),("HACK","Amplify网络安全ETF","Amplify Cybersecurity ETF"),("BUG","Global X网络安全ETF","Global X Cybersecurity ETF"),("IGV","iShares软件ETF","iShares Software ETF"),("WCLD","WisdomTree云软件ETF","WisdomTree Cloud ETF")]},

 {"n":"互联网与中概","en":"Internet & China ADR","layer":"下游·平台","stars":4,
  "desc":"中美互联网平台:中概 ADR + 美股社媒/流媒体,流量+AI 商业化双驱动。",
  "us":[("BABA","阿里巴巴","Alibaba"),("PDD","拼多多","PDD Holdings"),("JD","京东","JD.com"),("BIDU","百度","Baidu"),("NTES","网易","NetEase"),("TME","腾讯音乐","Tencent Music"),("BILI","哔哩哔哩","Bilibili"),("TCOM","携程","Trip.com"),("BEKE","贝壳","KE Holdings"),("FUTU","富途","Futu"),("VIPS","唯品会","Vipshop"),("YMM","满帮","Full Truck Alliance"),("WB","微博","Weibo"),("IQ","爱奇艺","iQIYI"),("NFLX","奈飞","Netflix"),("SPOT","Spotify","Spotify"),("RDDT","Reddit","Reddit"),("PINS","Pinterest","Pinterest"),("DASH","DoorDash","DoorDash"),("ABNB","爱彼迎","Airbnb")],
  "cn":[("002027","分众传媒"),("300413","芒果超媒"),("002555","三七互娱"),("002624","完美世界"),("002517","恺英网络"),("002602","世纪华通"),("002558","巨人网络"),("002605","姚记科技"),("002315","焦点科技"),("300785","值得买"),("300571","平治信息"),("300017","网宿科技"),("002174","游族网络"),("603533","掌阅科技"),("300296","利亚德")],
  "etf":[("KWEB","KraneShares中概互联ETF","KraneShares CSI China Internet ETF"),("CQQQ","Invesco中国科技ETF","Invesco China Technology ETF"),("PGJ","Invesco金龙中国ETF","Invesco Golden Dragon China ETF"),("QQQ","Invesco纳指100","Invesco QQQ"),("513050","中概互联网ETF")]},

 {"n":"消费电子与AI终端","en":"Consumer Electronics & AI Devices","layer":"下游·终端","stars":4,
  "desc":"AI 手机/PC/AIoT/可穿戴换机潮,声光电模组、组装、面板、电池链受益。",
  "us":[("AAPL","苹果","Apple"),("HPQ","惠普","HP Inc"),("LOGI","罗技","Logitech"),("GRMN","Garmin","Garmin"),("SONO","Sonos","Sonos"),("GPRO","GoPro","GoPro"),("CRSR","海盗船","Corsair"),("VUZI","Vuzix","Vuzix"),("KOSS","Koss","Koss"),("IMMR","Immersion","Immersion")],
  "cn":[("002241","歌尔股份"),("688036","传音控股"),("300433","蓝思科技"),("002600","领益智造"),("000725","京东方A"),("000100","TCL科技"),("002841","视源股份"),("300207","欣旺达"),("000049","德赛电池"),("601231","环旭电子"),("300735","光弘科技"),("603327","福蓉科技"),("688210","统联精密"),("300686","智动力"),("300115","长盈精密"),("002475","立讯精密"),("002138","顺络电子"),("002938","鹏鼎控股"),("002384","东山精密"),("002351","漫步者")],
  "etf":[("XLK","科技ETF","Technology Select Sector SPDR"),("QQQ","Invesco纳指100","Invesco QQQ"),("SOXX","iShares半导体ETF","iShares Semiconductor ETF"),("515260","电子ETF"),("159732","消费电子ETF")]},
]
